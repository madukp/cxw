...
public class PerformanceMissionPage {
	...
	public void clickLeftNavMissions() {
		...
		// By leftNavMission = By.xpath(".//a[contains(text(),'Mission') AND
		// @class='tab mission']");
		try {
			Thread.sleep(4000);
	...
	public void typeParticipantInstructions() {
		By txtParticipantInstructions = By.xpath(
				".//div[contains(@id,'taTextElement') and @placeholder='Enter detailed instructions for users']");
	...
	public void selectMediaUpload() {
		By checkBoxMediaInstructions = By.xpath(
				".//div[@class='mediaUpload']//div[@class='checkbox']//label[contains(text(),'Enable Media Upload')]");
	...
	public void typeMediaInstructions() {
		By txtMediaInstructions = By.xpath(
				".//div[contains(@id,'taTextElement') and contains(@placeholder,'what kind of media to upload')]");
